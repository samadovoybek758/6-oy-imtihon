...
function FilterCard(props) {
  ...
  return (
    <div onClick={() =>{Click_card(id)}} className='w-96 flex flex-col gap-4 border border-solid border-orange-600 rounded-md px-3 py-4 text-center' >
        <img  className='mx-auto cover' src={thumbnailUrl} alt="" />
